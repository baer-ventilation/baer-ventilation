...
(function () {
  ...
  var i18n = {
    en: {
      ...
      'cert-ce': 'EU Market Access', 'cert-rohs': 'Hazardous Substance Free', 'cert-iso': 'Quality Management',
      'cert-ip': 'Ingress Protection', 'cert-saa': 'Australia Approved', 'cert-energy': 'Energy Star Compliant',
    ...
    ar: {
      ...
      'cert-ce': 'دخول السوق الأوروبي', 'cert-rohs': 'خالٍ من المواد الضارة', 'cert-iso': 'إدارة الجودة',
      'cert-ip': 'درجة الحماية من الغبار والماء', 'cert-saa': 'معتمد في أستراليا', 'cert-energy': 'موفر للطاقة',
    ...
    zh: {
      ...
      'cert-ce': 'EU市场准入', 'cert-rohs': '无有害物质', 'cert-iso': '质量管理体系',
      'cert-ip': '防护等级', 'cert-saa': '澳大利亚认证', 'cert-energy': '节能认证',
